                        ...
                        {isHomePage && (
                            <div className="flex flex-row gap-3 justify-center mt-4 md:mt-6">
                                <Link
                                    ...
                                    className="!text-[#5B1824] bg-white hover:bg-[#FAF8F5] border-2 border-[#D4A244] inline-flex items-center justify-center px-5 py-2.5 md:px-8 md:py-3 text-xs md:text-base font-extrabold rounded-xl shadow-xl transition-all hover:-translate-y-0.5"
                                >
