// FAQs data - IATMSI-2027

export const faqsData = {
    title: "Frequently Asked Questions (FAQs)",
    subtitle: "Find quick answers to common questions regarding paper submission, registration, presentation rules, certificates, and conference policies.",

    categories: [
        { id: "all", label: "All Questions" },
        { id: "registration", label: "Registration & Fees" },
        { id: "presentation", label: "Presentation & Certificates" },
        { id: "submission", label: "Submission & IEEE Guidelines" },
        { id: "mode-visa", label: "Mode, Venue & Visa" }
    ],
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: "Presentation dates would be from 20th May to 22nd May 2027. Schedule will be uploaded as per dates mentioned on the website."
        },
        {
            id: 5,
            category: "presentation",
        ...
        },
        {
            ...
            answer: "No. Only 1 Author needs to register as Author and rest can be registered as Attendees, if they needs individual certificate."
        },
        {
            id: 10,
            category: "presentation",
        ...
        },
        {
            id: 16,
            category: "registration",
            question: "I wrote the paper as a student in May 2026 as part of my final semester thesis. However, I am a working professional now. Does this make me eligible to register at the conference as a student or as a professional?",
        ...
        },
        {
            id: 22,
            category: "mode-visa",
            question: "What does “Hybrid” mode mean? Am I allowed to present my paper virtually or do I have to be physically present in Kathmandu?",
        ...
        },
        {
            ...
            answer: "Yes, you will receive the certificate of the presentation but not be eligible for the best paper award. Also, your paper will be published in IEEE Xplore."
        },
        {
            id: 24,
            category: "mode-visa",
            ...
            answer: "No accommodation will be provided. If you attend physically then you can enjoy the cultural programs, gala dinner, and other events during the conference. Registration fees include a registration kit, three days lunch coupons, high tea, cultural event coupons and one-day Gala dinner coupons."
        },
        {
            id: 25,
            category: "presentation",
